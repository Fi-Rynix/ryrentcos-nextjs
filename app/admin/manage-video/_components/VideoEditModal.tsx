...
export default function VideoEditModal({ video, onClose }: VideoEditModalProps) {
  ...
  useEffect(() => {
    if (editorRef.current) {
      editorRef.current.innerHTML = video.description;
    }
  }, [video.description]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log("Update video:", video.id, {
      ...formData,
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      ...
      <div className="relative max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-2xl bg-white p-6 shadow-xl scrollbar-hide">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            <h2 className="text-xl font-bold text-brand-red">Edit Video</h2>
        ...
        <div className="mb-4 inline-flex items-center gap-2 rounded-lg bg-zinc-100 px-3 py-1.5">
          ...
          <span className="text-sm font-bold text-zinc-700">{video.id}</span>
        </div>
