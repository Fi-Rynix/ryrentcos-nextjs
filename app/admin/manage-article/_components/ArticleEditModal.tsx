...
export default function ArticleEditModal({ article, onClose }: ArticleEditModalProps) {
  ...
  useEffect(() => {
    if (editorRef.current) {
      editorRef.current.innerHTML = article.title;
    }
  }, [article.title]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log("Update article:", article.id, {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      ...
      <div className="relative max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-2xl bg-white p-6 shadow-xl scrollbar-hide">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            <h2 className="text-xl font-bold text-brand-red">Edit Artikel</h2>
        ...
        <div className="mb-4 inline-flex items-center gap-2 rounded-lg bg-zinc-100 px-3 py-1.5">
          ...
          <span className="text-sm font-bold text-zinc-700">{article.id}</span>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="flex gap-3">
              {(["AniManga", "IRL Event", "Gorengan"] as Category[]).map((cat) => (
                <label
                  key={cat}
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="flex flex-col rounded-xl border-2 border-zinc-200 overflow-hidden focus-within:border-brand-red focus-within:ring-2 focus-within:ring-brand-red/20">
              ...
              <div
                ...
                data-placeholder="Tuliskan deskripsi artikel di sini..."
              />
            </div>
          </div>
