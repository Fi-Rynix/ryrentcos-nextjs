    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      ...
      <div className="relative max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-2xl bg-white p-6 shadow-xl scrollbar-hide">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            <h2 className="text-xl font-bold text-brand-red">Tambah Produk Baru</h2>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              placeholder="(Fullset) Cosplay Columbina - Genshin Impact"
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="105.000"
                  className="h-12 w-full rounded-xl border-2 border-zinc-200 bg-zinc-50 pl-10 pr-4 text-sm text-zinc-800 placeholder:text-zinc-400 focus:border-brand-red focus:bg-white focus:outline-none focus:ring-2 focus:ring-brand-red/20"
                />
              </div>
            </div>
            <div className="flex flex-col gap-1.5">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="flex flex-col rounded-xl border-2 border-zinc-200 overflow-hidden focus-within:border-brand-red focus-within:ring-2 focus-within:ring-brand-red/20">
              ...
              <div
                ...
                data-placeholder="Tuliskan deskripsi produk di sini..."
              />
            </div>
          </div>
