...
function RelatedCard({ item }: { item: RelatedArticle }) {
  return (
    <article className="flex h-56 w-full flex-col gap-4 overflow-hidden rounded-[10px] bg-white p-[15px] shadow-[2px_2px_8px_0px_rgba(0,0,0,0.25)] sm:h-44 sm:flex-row sm:items-center sm:gap-6">
    ...
    <div className="min-h-screen w-full bg-brand-base-soft">
      <div className="mx-auto w-full max-w-[1129px] px-4 pb-16 pt-10 md:px-6 lg:px-0">
        <div className="flex flex-col items-center gap-16">
          ...
          {/* Main content area */}
          <div className="grid w-full gap-16 lg:grid-cols-[1fr_320px] lg:items-start">
            ...
            <article className="flex w-full flex-col gap-7">
              ...
              {/* Main image */}
              <div className="relative aspect-video h-96 w-full overflow-hidden rounded-lg bg-zinc-300">
                <Image
              ...
              <div className="flex w-full flex-col gap-2">
                ...
                <span className="text-base leading-5 text-brand-red">
