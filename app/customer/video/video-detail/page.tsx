...
function VideoPlayer() {
  return (
    <div className="relative aspect-video w-full overflow-hidden rounded-[5px] sm:h-[400px] lg:h-[630px]">
      <Image
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="flex h-14 w-14 items-center justify-center rounded-full bg-white/40 shadow-lg transition-transform hover:scale-110 sm:h-20 sm:w-20 lg:h-24 lg:w-24">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="white" className="sm:h-8 sm:w-8 lg:h-10 lg:w-10">
...
function RelatedCard({ item }: { item: RelatedVideo }) {
  return (
    <div className="flex w-full flex-col gap-3 overflow-hidden rounded-[10px] bg-white p-3 shadow-[2px_2px_8px_0px_rgba(0,0,0,0.25)] sm:h-56 sm:flex-row sm:items-center sm:gap-6 sm:p-1 lg:gap-10">
      {/* Thumbnail */}
        ...
        <div className="flex flex-col items-center gap-8 sm:gap-12 lg:gap-16">
          ...
          <div className="flex w-full flex-col">
            ...
            <article className="flex w-full flex-col gap-7">
              {/* Title */}
              <h1 className="text-2xl font-bold leading-tight text-black sm:text-4xl sm:leading-tight md:text-5xl md:leading-[60px] lg:text-6xl lg:leading-[68px]">
                {VIDEO_DATA.title}
              </h1>
